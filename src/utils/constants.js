...
export const SIZE_MOB = 480;
export const SIZE_DES = 1024;
export const SIZE_TAB = 768;
export const MOVIES_DES = 12;
export const MOVIES_MOB = 5;
export const MOVIES_TAB = 8;
export const LOAD_TAB_MOB = 2;
export const LOAD_DES = 3;